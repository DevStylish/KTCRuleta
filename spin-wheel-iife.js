...
var spinWheel = ( () => {
    ...
    var L = Math.pow
      ...
      , v = (i, e) => {
        for (var t in e || (e = {}))
            E.call(e, t) && I(i, t, e[t]);
        if (x)
            for (var t of x(e))
                Y.call(e, t) && I(i, t, e[t]);
        return i
    }
    ;
    var q = (i, e) => {
      ...
      , $ = (i, e, t, s) => {
        if (e && typeof e == "object" || typeof e == "function")
            for (let n of X(e))
                !E.call(i, n) && n !== t && R(i, n, {
                    get: () => e[n],
                    enumerable: !(s = H(e, n)) || s.enumerable
                });
        return i
    }
    ;
    var Q = i => $(R({}, "__esModule", {
        value: !0
    }), i);
    var ee = {};
    q(ee, {
    ...
    function T(i={
        ...
        return L(i.x - e, 2) + L(i.y - t, 2) <= L(s, 2)
    }
    function S(i={
        x: 0,
        y: 0
    ...
    function U(i=0, e=0) {
        let t = i + e, s;
        return t > 0 ? s = t % 360 : s = 360 + t % 360,
        s === 360 && (s = 0),
        s
    }
    function z(i=0, e=0) {
    ...
    function V(i=0, e=0, t=1) {
        let s = (i % 360 + e) % 360;
        return s = J(s),
        s = (t === 1 ? 360 - s : 360 + s) % 360,
        s *= t,
        i + s
    }
    function b(i) {
    ...
    function O(i={}) {
        K(i),
        i._handler_onResize = D(i._canvasContainer, ({redraw: t=!0}) => {
            i.resize(),
        ...
        let e = () => {
            ...
            i._mediaQueryList.addEventListener("change", i._handler_onDevicePixelRatioChange, {
                once: !0
            })
        }
        ;
    ...
    function B(i={}) {
        let e = i.canvas;
        "PointerEvent"in window ? (e.removeEventListener("pointerdown", i._handler_onPointerDown),
        e.removeEventListener("pointermove", i._handler_onPointerMoveRefreshCursor)) : (e.removeEventListener("touchstart", i._handler_onTouchStart),
        e.removeEventListener("mousedown", i._handler_onMouseDown),
        e.removeEventListener("mousemove", i._handler_onMouseMoveRefreshCursor)),
    ...
    function K(i={}) {
        ...
        i._handler_onPointerMoveRefreshCursor = (t={}) => {
            ...
            i._isCursorOverWheel = i.wheelHitTest(s),
            i.refreshCursor()
        }
        ,
        ...
        i._handler_onPointerDown = (t={}) => {
            ...
            if (!i.isInteractive || !i.wheelHitTest(s))
                return;
            t.preventDefault(),
            i.dragStart(s),
        ...
        ,
        "PointerEvent"in window ? (e.addEventListener("pointerdown", i._handler_onPointerDown),
        e.addEventListener("pointermove", i._handler_onPointerMoveRefreshCursor)) : (e.addEventListener("touchstart", i._handler_onTouchStart),
    ...
    var y = class {
        ...
        set backgroundColor(e) {
            typeof e == "string" ? this._backgroundColor = e : this._backgroundColor = o.item.backgroundColor,
            this._wheel.refresh()
        }
        get image() {
            return this._image
        ...
        set imageOpacity(e) {
            typeof e == "number" ? this._imageOpacity = e : this._imageOpacity = o.item.imageOpacity,
            this._wheel.refresh()
        }
        get imageRadius() {
        ...
        set imageRadius(e) {
            typeof e == "number" ? this._imageRadius = e : this._imageRadius = o.item.imageRadius,
            this._wheel.refresh()
        }
        get imageRotation() {
        ...
        set imageRotation(e) {
            typeof e == "number" ? this._imageRotation = e : this._imageRotation = o.item.imageRotation,
            this._wheel.refresh()
        }
        get imageScale() {
        ...
        set imageScale(e) {
            typeof e == "number" ? this._imageScale = e : this._imageScale = o.item.imageScale,
            this._wheel.refresh()
        }
        get label() {
            return this._label
        ...
        set labelColor(e) {
            typeof e == "string" ? this._labelColor = e : this._labelColor = o.item.labelColor,
            this._wheel.refresh()
        }
        get value() {
            return this._value
        ...
        getRandomAngle() {
            return W(this.getStartAngle(), this.getEndAngle())
        }
    }
    ;
    var M = class {
        ...
        remove() {
            this.canvas !== null && (this._frameRequestId !== null && window.cancelAnimationFrame(this._frameRequestId),
            B(this),
        ...
        resize() {
            ...
            this._size = Math.max(n.w * r, n.h * r),
            this._center = {
                x: e / 2 + e * this._offset.x,
                y: t / 2 + t * this._offset.y
            },
            this._actualRadius = this._size / 2 * this.radius,
            this._itemLabelFontSize = this.itemLabelFontSizeMax * (this._size / 500),
            ...
            for (let a of this._items)
                this._itemLabelFontSize = Math.min(this._itemLabelFontSize, P(a.label, this.itemLabelFont, this._labelMaxWidth, this._context));
            this.refresh()
        }
        draw(e=0) {
        ...
        drawItemImages(e, t=[]) {
            for (let[s,n] of t.entries()) {
                ...
                e.translate(this._center.x + Math.cos(m(a + -90)) * (this._actualRadius * r.imageRadius), this._center.y + Math.sin(m(a + -90)) * (this._actualRadius * r.imageRadius)),
                e.rotate(m(a + r.imageRotation)),
                e.globalAlpha = r.imageOpacity;
                let d = this._size / 500 * r.image.width * r.imageScale
                  , h = this._size / 500 * r.image.height * r.imageScale
                  , C = -d / 2
                  , _ = -h / 2;
                e.drawImage(r.image, C, _, d, h),
                e.restore()
            }
        }
        drawImage(e, t, s=!1) {
            ...
            let n = s ? this._size : this._size * this.radius
              , r = -(n / 2);
            e.drawImage(t, r, r, n, n),
            e.resetTransform()
        }
        drawDebugPointerLine(e) {
            !this.debug || (e.translate(this._center.x, this._center.y),
        ...
        drawBorder(e) {
            ...
            e.strokeStyle = s,
            e.lineWidth = t,
            e.arc(this._center.x, this._center.y, this._actualRadius - t / 2, 0, 2 * Math.PI),
            e.stroke(),
            this.debug) {
                ...
                e.lineWidth = n,
                e.arc(this._center.x, this._center.y, this._actualRadius * this.itemLabelRadius, 0, 2 * Math.PI),
                e.stroke(),
                e.beginPath(),
                e.strokeStyle = e.strokeStyle = f.labelRadiusColor,
                e.lineWidth = n,
                e.arc(this._center.x, this._center.y, this._actualRadius * this.itemLabelRadiusMax, 0, 2 * Math.PI),
                e.stroke()
            }
        }
        drawItemLines(e, t=[]) {
            ...
            e.translate(this._center.x, this._center.y);
            for (let r of t)
                e.rotate(m(r.start + -90)),
                e.beginPath(),
                e.moveTo(0, 0),
                e.lineTo(this._actualRadius - n, 0),
        ...
        drawItemLabels(e, t=[]) {
            ...
            for (let[a,d] of t.entries()) {
                ...
                if (h.label.trim() === "" || C === "transparent")
                    continue;
                e.save(),
                e.clip(h.path);
                let _ = d.start + (d.end - d.start) / 2;
                if (e.translate(this._center.x + Math.cos(m(_ + -90)) * (this._actualRadius * this.itemLabelRadius), this._center.y + Math.sin(m(_ + -90)) * (this._actualRadius * this.itemLabelRadius)),
                e.rotate(m(_ + -90)),
                e.rotate(m(this.itemLabelRotation)),
                this.debug) {
                    e.save();
                    let c = 0;
                    this.itemLabelAlign === "left" ? c = this._labelMaxWidth : this.itemLabelAlign === "center" && (c = this._labelMaxWidth / 2),
                    e.beginPath(),
                    e.moveTo(c, 0),
                    e.lineTo(-this._labelMaxWidth + c, 0),
                    e.strokeStyle = f.labelBoundingBoxColor,
                    e.lineWidth = n,
                    e.stroke(),
                    e.strokeRect(c, -this._itemLabelFontSize / 2, -this._labelMaxWidth, this._itemLabelFontSize),
                    e.restore()
                }
                if (this._itemLabelStrokeWidth > 0 && (e.lineWidth = r,
                e.strokeStyle = this._itemLabelStrokeColor,
                e.lineJoin = "round",
                e.strokeText(h.label, 0, s)),
                e.fillStyle = C,
                e.fillText(h.label, 0, s),
                this.debug) {
                    let c = this.getScaledNumber(2);
                    e.beginPath(),
                    e.arc(0, 0, c, 0, 2 * Math.PI),
                    e.fillStyle = f.labelRadiusColor,
                    e.fill()
                }
                e.restore()
            }
        ...
        drawDebugDragPoints(e) {
            var r;
            if (!this.debug || !((r = this._dragEvents) != null && r.length))
                return;
            ...
            for (let[a,d] of t.entries()) {
                ...
                e.beginPath(),
                e.arc(d.x, d.y, n, 0, 2 * Math.PI),
                e.fillStyle = `hsl(${f.dragPointHue},100%,${h}%)`,
                e.strokeStyle = "#000",
                e.lineWidth = s,
                e.fill(),
                e.stroke()
        ...
        animateRotation(e=0) {
            if (this._spinToTimeEnd !== null) {
                ...
                this.rotation = this._spinToStartRotation + n * this._spinToEasingFunction(s),
                this.refresh();
                return
            }
            if (this._lastSpinFrameTime !== null) {
                let t = e - this._lastSpinFrameTime;
                t > 0 && (this.rotation += t / 1e3 * this._rotationSpeed % 360,
                this._rotationSpeed = this.getRotationSpeedPlusDrag(t),
                this._rotationSpeed === 0 ? (this.raiseEvent_onRest(),
                this._lastSpinFrameTime = null) : this._lastSpinFrameTime = e),
                this.refresh();
                return
            }
        }
        ...
        spinToItem(e=0, t=0, s=!0, n=1, r=1, a=null) {
            ...
            let d = s ? this.items[e].getCenterAngle() : this.items[e].getRandomAngle()
              , h = V(this.rotation, d - this._pointerAngle, r);
            h += n * 360 * r,
            this.animate(h, t, a),
            this.raiseEvent_onSpin({
                method: "spintoitem",
        ...
        animate(e, t, s) {
            ...
            this._spinToEasingFunction = s || F,
            this.refresh()
        }
        stop() {
            this._spinToTimeEnd = null,
        ...
        wheelHitTest(e={
            ...
            if (this.canvas === null)
                return !1;
            let t = S(e, this.canvas, this.getActualPixelRatio());
            return T(t, this._center.x, this._center.y, this._actualRadius)
        }
        refreshCursor() {
            if (this.canvas !== null) {
        ...
        getAngleFromCenter(e={
            ...
            return (k(this._center.x, this._center.y, e.x, e.y) + 90) % 360
        }
        getCurrentIndex() {
        ...
        refreshCurrentIndex(e=[]) {
            ...
            for (let[t,s] of e.entries())
                if (!!A(this._pointerAngle, s.start % 360, s.end % 360)) {
        ...
        getItemAngles(e=0) {
            ...
            for (let d of this._items)
                ...
                r += n;
            return this._items.length > 1 && (a[a.length - 1].end = a[0].start + 360),
            a
        }
        refresh() {
        ...
        raiseEvent_onCurrentIndexChange(e={}) {
            var t;
            (t = this.onCurrentIndexChange) == null || t.call(this, v({
        ...
        raiseEvent_onRest(e={}) {
            var t;
            (t = this.onRest) == null || t.call(this, v({
                type: "rest",
                currentIndex: this._currentIndex,
        ...
        raiseEvent_onSpin(e={}) {
            var t;
            (t = this.onSpin) == null || t.call(this, v({
                type: "spin"
            }, e))
        }
    }
